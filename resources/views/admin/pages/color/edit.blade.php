        ...
        <div class="row">
            <div class="col-12">
                <div class="progress-container bg-white rounded-30 p-sm-5 p-3 mb-3">
                    ...
                    <form class="needs-validation" method="post" action="{{ route('admin.color-update',$color->id) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                <label for="validationTooltip02">Name</label>
                                <input type="text" class="form-control" name="name" id="validationTooltip02" value="{{$color->name}}"
                        ...
                        <div class="form-row">
                            <div class="col-md-4 mb-3">
                                ...
                                <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="3">{{$color->description}}</textarea>
                            </div>
                        </div>
